...
/* false && console.log('[BOOT][main1] starting machine=',configFile.myID,' ip=',myDataActor.IP,' port=',myDataActor.Port,' streaming=',configFile.streaming) */
...
/* false && console.log('[BOOT][main1] masterfile_under_modifications created') */
...
/* false && console.log('[BOOT][main1] REPLIER flow initialized') */

setTimeout(() => {REQUESTER(external_judge,judge_object,configFile.largeDataPort,client_largeData,Second_Process,Requester_eventEmitter,end_event,transaction_creator,processFiles,LocalActorConnection,Requesters_log,Rules_object,Signature_Validator,metadatahash,qkdSecurity)
    /* false && console.log('[BOOT][main1] REQUESTER flow initialized') */
}, 1000);
